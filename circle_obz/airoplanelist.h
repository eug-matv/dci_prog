//---------------------------------------------------------------------------
/*
airoplanelist.cpp, airoplanelist.h - реализация упорядочивания вывода
графических дланных по 12 секторам.
Автор Матвеенко Е.А.

Описание:
Сначала данные одного сектора 30 градусов
выводятся, затем следующие. Таким же образом затираются данные с прошлого
обзора.
